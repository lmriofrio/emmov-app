...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const data = {
    ...
    "UNIDAD DE CARGA Y REMOLQUE": ['REMOLQUE', 'SEMIRREMOLQUE', 'TRACTO CAMION'],
    "VEHÍCULO ESPECIAL": ['AMBULANCIA', 'BASURERO', 'BOMBERO', 'CONCRETERA', 'GRUA', 'HORMIGONERO', 'RECOLECTOR', 'TANQUERO', 'TOLVA', 'VOLQUETA']
  };
